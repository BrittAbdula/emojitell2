        ...
        <div className="flex flex-col items-center justify-between gap-4 md:h-16 md:flex-row">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            <a 
              ...
              className="text-xs md:text-sm text-gray-600 dark:text-gray-400 underline underline-offset-4 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
            >
              Terms
            </a>
            <a 
